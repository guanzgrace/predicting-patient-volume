...
_, mses1, y_pred1 = run_dynamic_rnn(build_rnn_model2, "Dynamic-RNN-RespVisits-32-32",
BASE_FEATURES, ICD8_LABEL, epochs, patience, trials)

_, mses1, y_pred1 = run_dynamic_rnn(build_rnn_model2, "Dynamic-RNN-NonRespVisits-32-32",
BASE_FEATURES, ICD8OPP_LABEL, epochs, patience, trials)

...
def run_one_step_ahead_rnn_for_graph(filename, name, features, label):
    print("\n\n")
    print(name)
    ...
    mod = compile_rnn_weights_from_file(filename, X_train, 32, 32)
    ...
    print(list(np.array(predictions).reshape(-1)))
...
mses1, y_pred1 = run_one_step_ahead_rnn_for_graph("../OSA-RNN-7DayLag-AllVisits-Trial0-1562379771.9270277.h5",
"OSA-RNN-7DayLag-AllVisits", SEVEN_DAY_LAG_FEATURES, ALL_VISITS_LABEL)

mses1, y_pred1 = run_one_step_ahead_rnn_for_graph("../OSA-RNN-7DayLag-Resp-Trial0-1562382449.7247682.h5",
"OSA-RNN-7DayLag-Resp", SEVEN_DAY_LAG_ICD8_FEATURES, ICD8_LABEL)

mses1, y_pred1 = run_one_step_ahead_rnn_for_graph("../OSA-RNN-7DayLag-NonResp-Trial0-1562386386.4424531.h5", 
"OSA-RNN-7DayLag-NonResp", SEVEN_DAY_LAG_ICD8OPP_FEATURES, ICD8OPP_LABEL)

...
mses1, y_pred1 = run_one_step_ahead_rnn("OSA-RNN-1DayLag-AllVisits",
ONE_DAY_LAG_FEATURES, ALL_VISITS_LABEL, epochs, patience, trials)

mses1, y_pred1 = run_one_step_ahead_rnn("OSA-RNN-1DayLag-Resp",
ONE_DAY_LAG_ICD8_FEATURES, ICD8_LABEL, epochs, patience, trials)

mses1, y_pred1 = run_one_step_ahead_rnn("OSA-RNN-1DayLag-NonResp",
